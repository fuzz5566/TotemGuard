...
@CheckData(name = "Syncac", description = "Usage of the Syncac mod")
public class Syncac extends ModCheck {
    public Syncac(TotemPlayer player) {
        super(player, List.of(
                "key.syncac.toggle_attack",
                "key.syncac.toggle_use"
        ));
    }
}
