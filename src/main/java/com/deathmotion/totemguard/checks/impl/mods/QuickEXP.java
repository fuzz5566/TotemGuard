...
@CheckData(
        name = "QuickEXP",
        description = "Usage of the Quick Exp mod"
)
public class QuickEXP extends Check implements PacketCheck {

    private static final String QUICKEXP_CHANNEL = "quickexp:optout";

    private boolean detected;

    public QuickEXP(final TotemPlayer player) {
        super(player);
    }
    ...
    public void onPacketReceive(PacketReceiveEvent event) {
        ...
        if (event.getPacketType()
            ...
            if (QUICKEXP_CHANNEL.equals(packet.getChannelName())) {
                detected = true;
                fail();
            }
        }
